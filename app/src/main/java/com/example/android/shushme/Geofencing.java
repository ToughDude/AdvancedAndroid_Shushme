...
import com.example.android.shushme.provider.GeofenceBroadcastReciever;
...
import static com.example.android.shushme.provider.GeofenceBroadcastReciever.TAG;
...
public class Geofencing implements ResultCallback {
    ...
    {
        if(mGoogleClient == null || mGoogleClient.isConnected() || mGeofenceList == null || mGeofenceList.size() == 0)
        {
            return;
        }
        try {
    ...
    public void updateGeofenceList(PlaceBuffer places)
    {
        ...
        for(Place place : places)
        {
            ...
            //Now Building a geofence object
            Geofence geofence = new Geofence.Builder()
                    .setRequestId(placeUID)
                    .setExpirationDuration(100000)
                    .setCircularRegion(placeLat,placeLong,(float)10.0)
